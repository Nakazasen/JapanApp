from frontend.services.vocab_practice_service import get_vocab_practice_service
...
class VocabPracticeTab(QWidget):
    def __init__(self):
        super().__init__()
        self.service = get_vocab_practice_service()
    ...
    def _init_ui(self):
        ...
        sidebar_lay.addWidget(QLabel("💹 LUYỆN TỪ VỰNG (JT4Y)"))
    ...
    def _analyze_content(self):
        ...
        def on_finished(result):
            ...
            if result.get("success"):
                ...
                toast_error(f"Phân tích thất bại: {result.get('error')}")
